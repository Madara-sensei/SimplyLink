        ...
        <div className={classes.root}>
                    <AppBar position="static">
                        ...
                        onClick={this.handleClick}>
                            ...
                            >   
                                <MenuItem onClick={this.handleClose} component={Link} to={'/Add'}>Add URL</MenuItem>
                                <MenuItem onClick={this.handleClose} component={Link} to={'/Account'}>My account</MenuItem>
